...
$(document).ready(function () {
    ...
    $.get(CDNROOTDIR + 'consoleChannelUIN.html', function (contents) {
...
function validateSite() {
    ...
    console.log("VALIDAT SITE URL : " + finalUrl);
    $.ajax({
        url: finalUrl
    }).then(function (data) {
        if (data === "HOME") {
            console.log("REGISTERED WEBSITE HOME : " + SITEURL.hostname);
            console.log("WEBSITE CONFIG : " + data);
            PARENTREGISTERED = true;
            validateConfiguration();
        } else {
            if (parseInt(data) > 0) {
                console.log("REGISTERED WEBSITE ID : " + SITEURL.hostname);
                console.log("WEBSITE CONFIG : " + data);
                PARENTREGISTERED = true;
                validateConfiguration();
            } else if (parseInt(data) === 0) {
                console.log("UNREGISTERED WEBSITE : " + SITEURL.hostname);
                console.log("WEBSITE CONFIG : " + data);
