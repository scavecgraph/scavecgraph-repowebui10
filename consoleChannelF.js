...
window.addEventListener('message', function(event) {
    console.log("*** POST MESSAGE EVENT embedChannel READY ********************");
    if (typeof event.data === 'string' && event.data.startsWith('embedChannel')) { 
        console.log("*** POST MESSAGE EVENT embedChannel EXECUTED ********************");
...
$(document).ready(function () {
    ...
    $.get(CDNROOTDIR + 'consoleChannelUIF.html', function (contents) {
...
function generateCSS(){
    ...
    if (navColor !== null && navColor !== "") {
        ...
        console.log("COLOR AGAIN : " + color);
        if (color === null || color === "") {
            NAVCOLOR = "#b5d7e8";
            console.log("NAVCOLOR AGAIN : " + NAVCOLOR);
        } else {
            NAVCOLOR = LIGHTESTCOLOR;
        }
    }
...
function configureUI() {
    if(PARENTORIGIN === null){
        ...
        console.log("NO REDIRACT DUE TO ESTABLISHED ORIGIN : " + PARENTORIGIN);
    }
    if(DEBUG){
    ...
    $('#channelTbl').css('border-color', '0px solid ' + NAVCOLOR);
    $('#channelTbl').css('background-color', NAVCOLOR);
    $('#trackerTd').css('background-color', NAVCOLOR);
    $('#rootTd').css('background-color', NAVCOLOR);
    $('#searchTd').css('background-color', NAVCOLOR);
